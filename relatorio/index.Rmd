...
Acesse: [J. Delpasso & M. Motta](index.html){target="_blank"}

# Página dos alunos da disciplina

- Acesse: [Página dos alunos da disciplina Estatística e probabilidade](https://bendeivide.github.io/courses/epaec/normal2026.1/#relat%C3%B3rio-dos-alunos){target="_blank"}
...
- [Relatório 01 João Delpasso(30/03/2026)](rel01Jp/index.html){target="_blank"} (Relatório individual antes da formação da dupla)
- [Relatório 01 Maria Eduarda Motta Rosa(30/03/2026)](rel01Me/index.html){target="_blank"} (Relatório individual antes da formação da dupla)
